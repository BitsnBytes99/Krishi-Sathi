...
const Features = () => {
  ...
  const gridData = [
    ...
    { title: "Drone Connect", image: droneImage, link: "/drone-connect" },
    { title: "Govt Scheme", image: schemeImage, link: "/govt-scheme" },
  ];
      ...
      <View className="flex-row flex-wrap justify-center gap-9">
        {gridData.map((item, index) => (
          <TouchableOpacity
            ...
            className=" bg-[#259e75] rounded-lg p-6 shadow-lg items-center justify-center w-40 h-40"
          >
